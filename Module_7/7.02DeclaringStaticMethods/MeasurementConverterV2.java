 ...
 * *****************************************************************************************************************************************
 *  this assignment was really easy to do and interesting. Is the first time that i use more than one public and i think that i am starting 
 *  to understand for what it's used.
 * *****************************************************************************************************************************************
 * 
...
public class MeasurementConverterV2
{
    ...
    public static void main(String[ ] args)
    {
        ...
        System.out.printf("%8.1f m. = %7.1f km. %n", meters, kilometers);
        
        
        
        kilometers = 29;
        meters = convertKilometersToMeters(kilometers);
        System.out.printf("%8.1f km. = %7.1f m. %n", kilometers, meters);   
    }//end of main method
