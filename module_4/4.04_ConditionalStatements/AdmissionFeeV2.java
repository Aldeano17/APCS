...
public class AdmissionFeeV2                                      //class declaration
{
    public static void main(String [] args)                     //beginning of main method
    {
        String yearsOld = "";                                   //age entered as a String
        int age = 0;                                            //age of person as an integer value
        boolean isChild;                                //default, person is not a child                                                        
        double admissionFee;                                //admission fee for adult
        ...
        if(isChild)                                             //evalueate if boolean is true or not
           ...
           admissionFee = 6.00;                                 //person is not a child, so charge a higher fee
